...
return [
    ...
    */
    ...
    'between'              => [
        ...
        'string'  => 'Simbolių kiekis lauke turi būti tarp :min ir :max.',
        'array'   => 'Leidžiamas elementų skaičius nuo :min iki :max.',
    ],
    ...
    'image'                => 'Pasirinktas failas nėra nuotrauka.',
    ...
    'max'                  => [
        ...
        'file'    => 'Failo dydis būti didesnis nei :max kilobaitų.',
        'string'  => 'Simbolių kiekis lauke negali būti didesnis nei :max.',
    ...
    'required'             => 'Privalote užpildyti šį lauką.',
    ...
    'uploaded'             => 'Nepavyko įkelti failo.',
    ...
    */
    'custom'               => [
        'email' => [
            'unique' => 'Naudotojas tokiu el. pašto adresu jau užregistruotas.',
        ],
        'username' => [
            'unique' => 'Naudotojas tokiu slapyvardžiu jau užregistruotas.',
        ],
        'password_confirmation' => [
            'same' => 'Slaptažodžio patvirtinimas nesutampa su slaptažodžiu.',
        ],
        'category' => [
            'required' => 'Privalote pasirinkti kategoriją.',
            'exists' => 'Pasirinkta neegzistuojanti kategorija.'
        ],
        'picture' => [
            'required' => 'Privalote pasirinkti nuotrauką.',
        ],
        'step' => [
            'required' => 'Privalote pateikti instrukcijas.',
            'between' => 'Privalote pateikti nuo :min iki :max instrukcijos žingsnių.',
        ],
        'ingredient' => [
            'required' => 'Privalote pateikti ingredientus.',
            'between' => 'Privalote pateikti nuo :min iki :max ingredientų.',
        ],
        'role' => [
            'exists' => 'Pasirinkta neegzistuojanti rolė.',
        ],
    ],
    /*
    |--------------------------------------------------------------------------
