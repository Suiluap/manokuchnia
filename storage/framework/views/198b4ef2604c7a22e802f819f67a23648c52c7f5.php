...
<form action="<?php echo e(route('recipe.edit', $recipe)); ?>" method="post" class="bg-light p-4 shadow-sm rounded mx-auto mb-5" style="max-width: 540px" enctype="multipart/form-data" novalidate>
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Pavadinimas" value="<?php echo e(old('name', $recipe->name)); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Aprašymas"><?php echo e(old('description', $recipe->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" placeholder="Porcijos" value="<?php echo e(old('portions', $recipe->portions)); ?>">
...
unset($__errorArgs, $__bag); ?>">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value=<?php echo e($category->id); ?> <?php echo e($category->id == $recipe->category_id ? "selected" : ""); ?>><?php echo e($category->name); ?></option>
                ...
                <?php $__currentLoopData = $recipe->ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div id="inputFormRow" class="mb-1">
                        <div class="input-group">
                            ...
                            <input id="ingredient" name="ingredient[]" type="text" class="form-control rounded-left" placeholder="Ingredientas" value="<?php echo e($ingredient->name); ?>" }}>
                            <label for="quantity" class="sr-only">Kiekis</label>
                            <input id="quantity" name="quantity[]" type="number" class="form-control" placeholder="Kiekis" value=<?php echo e($ingredient->quantity); ?>>
                            <label for="measurement" class="sr-only">Matavimo vienetas</label>
                            <input id="measurement" name="measurement[]" type="text" class="form-control" placeholder="Matavimo vienetas" value=<?php echo e($ingredient->measurement); ?>>
                ...
                <?php $__currentLoopData = $recipe->steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div id="inputFormRow" class="mb-1">
                        <div class="input-group">
                            ...
                            <input id="step" name="step[]" type="text" class="form-control rounded-left" placeholder="Žingsnis" value=<?php echo e($step->instructions); ?>>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Paulius\Desktop\manokuchnia\resources\views/recipes/edit.blade.php ENDPATH**/ ?>